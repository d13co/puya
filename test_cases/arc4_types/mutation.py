...
AliasedMutableDynamicArray: t.TypeAlias = MutableDynamicArray[UInt16]
AliasedStaticArray: t.TypeAlias = MutableStaticArray[UInt8, t.Literal[1]]
...
class Arc4MutationContract(Contract):
    ...
    def mutating_copies(self) -> None:
        my_array = MutableStaticArray(UInt8(1), UInt8(2), UInt8(3), UInt8(4))
    ...
    @subroutine
    def other_routine(
        self, array: MutableStaticArray[UInt8, typing.Literal[4]], struct: TestStruct
    ) -> None:
        array[1] = UInt8(5)
    ...
    @subroutine
    def subsub(self, arr: DynamicArray[UInt8]) -> None:
        pass

    @subroutine
    def array_concat(self) -> None:
        uint8_array = MutableDynamicArray(UInt8(1), UInt8(2))
        array_concat_tuple = uint8_array + (UInt8(3), UInt8(4))  # noqa: RUF005
        assert array_concat_tuple == MutableDynamicArray(UInt8(1), UInt8(2), UInt8(3), UInt8(4))
        array_concat_tuple += (UInt8(5),)
        assert array_concat_tuple == MutableDynamicArray(
            UInt8(1), UInt8(2), UInt8(3), UInt8(4), UInt8(5)
        )

        hello_world = MutableDynamicArray(String("Hello"), String("World"))
        hello_world_concat = MutableDynamicArray(String("Hello")) + MutableDynamicArray(
            String("World")
        )
    ...
    def array_of_array_dynamic(self) -> None:
        array_of_array = MutableDynamicArray[MutableDynamicArray[UInt8]]()
        assert array_of_array.bytes == Bytes.from_hex("0000")
        array_of_array.append(MutableDynamicArray[UInt8](UInt8(10)))
        assert array_of_array.bytes == Bytes.from_hex("0001000200010A")
        array_of_array.append(MutableDynamicArray[UInt8](UInt8(16)))
    ...
    def array_of_array_static(self) -> None:
        array_of_array = MutableStaticArray[
            MutableStaticArray[UInt8, typing.Literal[2]], typing.Literal[2]
        ](
            MutableStaticArray[UInt8, typing.Literal[2]](UInt8(10), UInt8(9)),
            MutableStaticArray[UInt8, typing.Literal[2]](UInt8(64), UInt8(128)),
        )

        assert array_of_array.bytes == Bytes.from_hex("0A094080")

        array_of_array[0] = MutableStaticArray[UInt8, typing.Literal[2]](UInt8(255), UInt8(254))
    ...
    def dynamic_array_fixed_size(self) -> None:
        ...
        assert dynamic_uint8_array == MutableDynamicArray[UInt8](UInt8(1), UInt8(2), UInt8(50))
        dynamic_uint8_array.extend(dynamic_uint8_array)

        assert dynamic_uint8_array == MutableDynamicArray[UInt8](
            UInt8(1), UInt8(2), UInt8(50), UInt8(1), UInt8(2), UInt8(50)
        )
        dynamic_uint8_array.extend((UInt8(4), UInt8(90)))

        assert dynamic_uint8_array == MutableDynamicArray(
    ...
    def dynamic_array_bool(self) -> None:
        dynamic_bool_array = MutableDynamicArray[Bool](Bool(True), Bool(False))
        ...
        assert dynamic_bool_array == MutableDynamicArray[Bool](
    ...
    def dynamic_array_string(self) -> None:
        ...
        foo = String("Foo")
        bar = String("Bar")
        dynamic_string_array = MutableDynamicArray(hello, world)
        ...
        assert dynamic_string_array == MutableDynamicArray(
            hello, world, foo, bar, hello, world, foo, bar
        )
        dynamic_string_array = MutableDynamicArray(hello, world, foo, bar, hello, world, foo, bar)
        ...
        assert dynamic_string_array == MutableDynamicArray(hello, world, foo, hello, hello, hello)
