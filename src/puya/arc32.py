...
def _encode_arc32_method_hint(metadata: ContractMetaData, method: ARC4Method) -> JSONDict:
    return {
...
def _encode_arc32_hints(metadata: ContractMetaData, methods: list[ARC4Method]) -> JSONDict:
    return {
